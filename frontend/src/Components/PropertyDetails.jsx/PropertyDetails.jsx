...
const incrementView = async () => {
  ...
  const getAmenityIcon = (amenity) => {
    ...
    if (amenityLower.includes('pool')) return <FaSwimmingPool className="text-yellow-500" />;
    if (amenityLower.includes('parking') || amenityLower.includes('garage')) return <FaCar className="text-yellow-500" />;
    if (amenityLower.includes('gym') || amenityLower.includes('fitness')) return <span className="text-yellow-500">🏋️</span>;
    if (amenityLower.includes('security')) return <span className="text-yellow-500">🔒</span>;
    if (amenityLower.includes('garden')) return <span className="text-yellow-500">🌿</span>;
    if (amenityLower.includes('wifi') || amenityLower.includes('internet')) return <span className="text-yellow-500">📶</span>;
    return <FaCheck className="text-yellow-500" />;
  };

  // Section heading component with toggle functionality
  const SectionHeading = ({ title, section }) => (
    <div 
      className="flex justify-between items-center cursor-pointer group"
      onClick={() => toggleSection(section)}
    >
      <h2 className="text-2xl font-bold text-gray-900 group-hover:text-yellow-500 transition-colors">
        {title}
      </h2>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-2">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        <div className="lg:w-2/3 w-full">
              ...
              <>
                ...
                <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                    <h3 className="text-lg font-semibold mb-2 hover:text-yellow-500 transition-colors">Area Details</h3>
                  ...
                  <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                    <h3 className="text-lg font-semibold mb-2 hover:text-yellow-500 transition-colors">Property Details</h3>
                    <div className="grid grid-cols-2 gap-4">
                      <div>
          ...
          {/* Description */}
          <div className="bg-white rounded-2xl shadow-sm p-6 mb-8 border border-gray-100">
            <SectionHeading title="Description" section="description" />
          ...
          {/* Amenities */}
          <div className="bg-white rounded-2xl shadow-sm p-6 mb-8 border border-gray-100">
            <SectionHeading title="Amenities" section="amenities" />
          ...
          {/* Seller Info */}
          <div className="bg-white rounded-2xl shadow-sm p-6 mb-8 border border-gray-100">
            <SectionHeading title="Seller Information" section="sellerInfo" />
            
            {expandedSections.sellerInfo && (
              <div className="flex flex-col md:flex-row md:items-center gap-6 p-4 bg-gray-50 rounded-xl border border-gray-100 mt-6">
                <div className="flex items-center">
                  <div className="w-16 h-16 rounded-full bg-yellow-100 flex items-center justify-center mr-4 text-yellow-500 text-xl font-bold">
                  ...
                  <div>
                    ...
                    <div className="flex items-center text-gray-700 mt-1">
                      <FaPhone className="mr-2 text-sm text-yellow-500" />
                ...
                <div className="md:ml-auto flex flex-col sm:flex-row gap-3">
                  <button
                    className="bg-yellow-500 text-white px-6 py-3 rounded-lg hover:bg-yellow-600 transition flex items-center justify-center"
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
            <SectionHeading title="Location" section="location" />
            
            {expandedSections.location && (
              <>
                <div className="h-80 rounded-xl overflow-hidden mb-4 border border-gray-200 mt-6">
                  {coordinates ? (
                    <MapContainer
